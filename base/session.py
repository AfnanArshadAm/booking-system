...
#     logged_node = Node.objects.filter(
#         id=get_from_local('logged_node_id')).first()
#     return logged_node
...
#         id=get_from_local('selected_node_id')).first()
#     if current_node:
#         set_to_local('selected_node_id', current_node.id)
#     return current_node
