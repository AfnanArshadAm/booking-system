...
class PhoneNumberField(serializers.CharField):
    ...
    def __init__(self, output_format=dict, **kwargs):
        ...
        if output_format not in self.supported_formats:
            raise ValueError("output_format not supported. It should be "
                             "either dict, str or list.")
...
#                 '%s not found in kwargs.' % self.field_name)
...
class RoundingDecimalField(serializers.DecimalField):
    """
    A decimal field that will automatically round to the specified decimal place
    """

    def __init__(self, actual_value=False, **kwargs):
        """
        Adds new parameter named actual value in this field.
        Which is used to return the actual value or the value with given 
        decimal points.
        """
    ...
    def round_decimal(value, places):
        if value is not None:
            ...
            try:
                ...
                raise BadRequest('Max length exceeded.')
        return value
    ...
    def to_representation(self, value):
        """
        On the basis of parameter actual_value if it's true the exact value returns
        else the exact value with given decimal points returns.
        """
